 ...
 */
public class ScatterPlot3DNodePlugin extends Plugin {
    // The shared instance.
    private static ScatterPlot3DNodePlugin plugin;

    /**
     * The constructor.
     */
    public ScatterPlot3DNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ScatterPlot3DNodePlugin getDefault() {
        return plugin;
    }
